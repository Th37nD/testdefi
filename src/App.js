...
import { abi } from "./abi";
const CONTRACT_ADDRESS = "0xa8F4965b46Db76B55826A59Fa53e2363c39A77E3";
...
function App() {
  ...
  async function changeNetwork() {
    // switch network to Binance SmartChain Mainnet
    try {
      ...
      if (switchError.code === 4902) {
        try {
          ...
          alert("Error in add Binance SmartChain Testnet");
        }
      }
    }
  }
